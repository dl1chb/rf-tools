...
License:        GPLv3
URL:            https://github.com/szechyjs/serialdv
...
%build
mkdir %{_builddir}/build && cd %{_builddir}/build && cmake -Wno-dev -DCMAKE_INSTALL_PREFIX=/opt/sdrangel/serialdv %{_builddir}/%{name}-%{version}
%make_build
